...
_Armistead_CellDeathDis2024 = amici._module_from_path(
    'Armistead_CellDeathDis2024._Armistead_CellDeathDis2024' if __package__ or '.' in __name__
    else '_Armistead_CellDeathDis2024',
    Path(__file__).parent / f'_Armistead_CellDeathDis2024{ext_suffix}',
)

def _get_import_time():
    return _Armistead_CellDeathDis2024._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Armistead_CellDeathDis2024 from '
...
%module(package="Armistead_CellDeathDis2024",moduleimport=MODULEIMPORT) Armistead_CellDeathDis2024
