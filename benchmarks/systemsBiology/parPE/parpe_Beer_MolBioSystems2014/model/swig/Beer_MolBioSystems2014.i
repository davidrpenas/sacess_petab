...
_Beer_MolBioSystems2014 = amici._module_from_path(
    'Beer_MolBioSystems2014._Beer_MolBioSystems2014' if __package__ or '.' in __name__
    else '_Beer_MolBioSystems2014',
    Path(__file__).parent / f'_Beer_MolBioSystems2014{ext_suffix}',
)

def _get_import_time():
    return _Beer_MolBioSystems2014._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Beer_MolBioSystems2014 from '
...
%module(package="Beer_MolBioSystems2014",moduleimport=MODULEIMPORT) Beer_MolBioSystems2014
