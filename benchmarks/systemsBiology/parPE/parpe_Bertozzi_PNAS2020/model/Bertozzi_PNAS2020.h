...
extern void Jy_Bertozzi_PNAS2020(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydsigma_Bertozzi_PNAS2020(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_Bertozzi_PNAS2020(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_Bertozzi_PNAS2020(SUNMatrixWrapper &colptrs, int index);
extern void dJydy_rowvals_Bertozzi_PNAS2020(SUNMatrixWrapper &rowvals, int index);
...
extern void dwdp_Bertozzi_PNAS2020(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const realtype *spl, const realtype *sspl, bool include_static);
extern void dwdp_colptrs_Bertozzi_PNAS2020(SUNMatrixWrapper &colptrs);
extern void dwdp_rowvals_Bertozzi_PNAS2020(SUNMatrixWrapper &rowvals);
extern void dwdx_Bertozzi_PNAS2020(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *spl, bool include_static);
extern void dwdx_colptrs_Bertozzi_PNAS2020(SUNMatrixWrapper &colptrs);
extern void dwdx_rowvals_Bertozzi_PNAS2020(SUNMatrixWrapper &rowvals);
extern void dwdw_Bertozzi_PNAS2020(realtype *dwdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, bool include_static);
extern void dwdw_colptrs_Bertozzi_PNAS2020(SUNMatrixWrapper &colptrs);
extern void dwdw_rowvals_Bertozzi_PNAS2020(SUNMatrixWrapper &rowvals);
extern void dxdotdw_Bertozzi_PNAS2020(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_Bertozzi_PNAS2020(SUNMatrixWrapper &colptrs);
extern void dxdotdw_rowvals_Bertozzi_PNAS2020(SUNMatrixWrapper &rowvals);
...
extern void dydx_Bertozzi_PNAS2020(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);





extern void sigmay_Bertozzi_PNAS2020(realtype *sigmay, const realtype t, const realtype *p, const realtype *k, const realtype *y);

extern void dsigmaydp_Bertozzi_PNAS2020(realtype *dsigmaydp, const realtype t, const realtype *p, const realtype *k, const realtype *y, const int ip);


extern void w_Bertozzi_PNAS2020(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl, const realtype *spl, bool include_static);
extern void x0_Bertozzi_PNAS2020(realtype *x0, const realtype t, const realtype *p, const realtype *k);
extern void x0_fixedParameters_Bertozzi_PNAS2020(realtype *x0_fixedParameters, const realtype t, const realtype *p, const realtype *k, gsl::span<const int> reinitialization_state_idxs);
extern void sx0_Bertozzi_PNAS2020(realtype *sx0, const realtype t, const realtype *x, const realtype *p, const realtype *k, const int ip);
extern void sx0_fixedParameters_Bertozzi_PNAS2020(realtype *sx0_fixedParameters, const realtype t, const realtype *x0, const realtype *p, const realtype *k, const int ip, gsl::span<const int> reinitialization_state_idxs);
extern void xdot_Bertozzi_PNAS2020(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void y_Bertozzi_PNAS2020(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
...
extern void x_solver_Bertozzi_PNAS2020(realtype *x_solver, const realtype *x_rdata);
...
extern std::vector<HermiteSpline> create_splines_Bertozzi_PNAS2020(const realtype *p, const realtype *k);
 ...
 */
class Model_Bertozzi_PNAS2020 : public amici::Model_ODE {
  public:
    /**
    ...
    Model_Bertozzi_PNAS2020()
        : amici::Model_ODE(
              ...
              amici::SimulationParameters(
                  ...
                  std::vector<realtype>{0.10000000000000001, 0.10000000000000001, 0.10000000000000001, 0.0, 0.0}        // dynamic parameters
              ),
    ...
    amici::Model *clone() const override {
        return new Model_Bertozzi_PNAS2020(*this);
    }
    ...
    void fJy(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        Jy_Bertozzi_PNAS2020(Jy, iy, p, k, y, sigmay, my);
    }
    ...
    void fdJydsigma(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydsigma_Bertozzi_PNAS2020(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    void fdsigmaydp(realtype *dsigmaydp, const realtype t, const realtype *p, const realtype *k, const realtype *y, const int ip) override {
        dsigmaydp_Bertozzi_PNAS2020(dsigmaydp, t, p, k, y, ip);
    }
    ...
    void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const realtype *spl, const realtype *sspl, bool include_static) override {
        dwdp_Bertozzi_PNAS2020(dwdp, t, x, p, k, h, w, tcl, dtcldp, spl, sspl, include_static);
    }

    void fdwdp_colptrs(SUNMatrixWrapper &colptrs) override {
        dwdp_colptrs_Bertozzi_PNAS2020(colptrs);
    }

    void fdwdp_rowvals(SUNMatrixWrapper &rowvals) override {
        dwdp_rowvals_Bertozzi_PNAS2020(rowvals);
    }
    ...
    void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *spl, bool include_static) override {
        dwdx_Bertozzi_PNAS2020(dwdx, t, x, p, k, h, w, tcl, spl, include_static);
    }

    void fdwdx_colptrs(SUNMatrixWrapper &colptrs) override {
        dwdx_colptrs_Bertozzi_PNAS2020(colptrs);
    }

    void fdwdx_rowvals(SUNMatrixWrapper &rowvals) override {
        dwdx_rowvals_Bertozzi_PNAS2020(rowvals);
    }
    ...
    void fdwdw(realtype *dwdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, bool include_static) override {
        dwdw_Bertozzi_PNAS2020(dwdw, t, x, p, k, h, w, tcl, include_static);
    }

    void fdwdw_colptrs(SUNMatrixWrapper &colptrs) override {
        dwdw_colptrs_Bertozzi_PNAS2020(colptrs);
    }

    void fdwdw_rowvals(SUNMatrixWrapper &rowvals) override {
        dwdw_rowvals_Bertozzi_PNAS2020(rowvals);
    }
    ...
    void fdxdotdw(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdw_Bertozzi_PNAS2020(dxdotdw, t, x, p, k, h, w);
    }

    void fdxdotdw_colptrs(SUNMatrixWrapper &colptrs) override {
        dxdotdw_colptrs_Bertozzi_PNAS2020(colptrs);
    }

    void fdxdotdw_rowvals(SUNMatrixWrapper &rowvals) override {
        dxdotdw_rowvals_Bertozzi_PNAS2020(rowvals);
    }
    ...
    void fdydx(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx) override {
        dydx_Bertozzi_PNAS2020(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    void fsigmay(realtype *sigmay, const realtype t, const realtype *p, const realtype *k, const realtype *y) override {
        sigmay_Bertozzi_PNAS2020(sigmay, t, p, k, y);
    }
    ...
    void fsx0(realtype *sx0, const realtype t, const realtype *x, const realtype *p, const realtype *k, const int ip) override {
        sx0_Bertozzi_PNAS2020(sx0, t, x, p, k, ip);
    }
    ...
    void fsx0_fixedParameters(realtype *sx0_fixedParameters, const realtype t, const realtype *x0, const realtype *p, const realtype *k, const int ip, gsl::span<const int> reinitialization_state_idxs) override {
        sx0_fixedParameters_Bertozzi_PNAS2020(sx0_fixedParameters, t, x0, p, k, ip,  reinitialization_state_idxs);
    }
    ...
    void fw(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl, const realtype *spl, bool include_static) override {
        w_Bertozzi_PNAS2020(w, t, x, p, k, h, tcl, spl, include_static);
    }


    void fx0(realtype *x0, const realtype t, const realtype *p, const realtype *k) override {
        x0_Bertozzi_PNAS2020(x0, t, p, k);
    }
    ...
    void fx0_fixedParameters(realtype *x0_fixedParameters, const realtype t, const realtype *p, const realtype *k, gsl::span<const int> reinitialization_state_idxs) override {
        x0_fixedParameters_Bertozzi_PNAS2020(x0_fixedParameters, t, p, k,  reinitialization_state_idxs);
    }
    ...
    void fxdot(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        xdot_Bertozzi_PNAS2020(xdot, t, x, p, k, h, w);
    }
    ...
    void fy(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        y_Bertozzi_PNAS2020(y, t, x, p, k, h, w);
    }
    ...
    void fx_solver(realtype *x_solver, const realtype *x_rdata) override {
        x_solver_Bertozzi_PNAS2020(x_solver, x_rdata);
    }
