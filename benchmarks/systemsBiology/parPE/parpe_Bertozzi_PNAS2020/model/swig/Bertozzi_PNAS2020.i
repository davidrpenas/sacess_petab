...
_Bertozzi_PNAS2020 = amici._module_from_path(
    'Bertozzi_PNAS2020._Bertozzi_PNAS2020' if __package__ or '.' in __name__
    else '_Bertozzi_PNAS2020',
    Path(__file__).parent / f'_Bertozzi_PNAS2020{ext_suffix}',
)

def _get_import_time():
    return _Bertozzi_PNAS2020._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Bertozzi_PNAS2020 from '
...
%module(package="Bertozzi_PNAS2020",moduleimport=MODULEIMPORT) Bertozzi_PNAS2020
