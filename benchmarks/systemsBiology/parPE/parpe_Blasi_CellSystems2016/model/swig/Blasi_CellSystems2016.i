...
_Blasi_CellSystems2016 = amici._module_from_path(
    'Blasi_CellSystems2016._Blasi_CellSystems2016' if __package__ or '.' in __name__
    else '_Blasi_CellSystems2016',
    Path(__file__).parent / f'_Blasi_CellSystems2016{ext_suffix}',
)

def _get_import_time():
    return _Blasi_CellSystems2016._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Blasi_CellSystems2016 from '
...
%module(package="Blasi_CellSystems2016",moduleimport=MODULEIMPORT) Blasi_CellSystems2016
