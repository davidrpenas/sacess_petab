...
_Boehm_JProteomeRes2014 = amici._module_from_path(
    'Boehm_JProteomeRes2014._Boehm_JProteomeRes2014' if __package__ or '.' in __name__
    else '_Boehm_JProteomeRes2014',
    Path(__file__).parent / f'_Boehm_JProteomeRes2014{ext_suffix}',
)

def _get_import_time():
    return _Boehm_JProteomeRes2014._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Boehm_JProteomeRes2014 from '
...
%module(package="Boehm_JProteomeRes2014",moduleimport=MODULEIMPORT) Boehm_JProteomeRes2014
