...
extern void Jy_Borghans_BiophysChem1997(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydsigma_Borghans_BiophysChem1997(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_Borghans_BiophysChem1997(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_Borghans_BiophysChem1997(SUNMatrixWrapper &colptrs, int index);
extern void dJydy_rowvals_Borghans_BiophysChem1997(SUNMatrixWrapper &rowvals, int index);
...
extern void dwdp_Borghans_BiophysChem1997(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const realtype *spl, const realtype *sspl, bool include_static);
extern void dwdp_colptrs_Borghans_BiophysChem1997(SUNMatrixWrapper &colptrs);
extern void dwdp_rowvals_Borghans_BiophysChem1997(SUNMatrixWrapper &rowvals);
extern void dwdx_Borghans_BiophysChem1997(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *spl, bool include_static);
extern void dwdx_colptrs_Borghans_BiophysChem1997(SUNMatrixWrapper &colptrs);
extern void dwdx_rowvals_Borghans_BiophysChem1997(SUNMatrixWrapper &rowvals);



extern void dxdotdw_Borghans_BiophysChem1997(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_Borghans_BiophysChem1997(SUNMatrixWrapper &colptrs);
extern void dxdotdw_rowvals_Borghans_BiophysChem1997(SUNMatrixWrapper &rowvals);
...
extern void dydx_Borghans_BiophysChem1997(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);
extern void dydp_Borghans_BiophysChem1997(realtype *dydp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w, const realtype *tcl, const realtype *dtcldp, const realtype *spl, const realtype *sspl);




extern void sigmay_Borghans_BiophysChem1997(realtype *sigmay, const realtype t, const realtype *p, const realtype *k, const realtype *y);

extern void dsigmaydp_Borghans_BiophysChem1997(realtype *dsigmaydp, const realtype t, const realtype *p, const realtype *k, const realtype *y, const int ip);


extern void w_Borghans_BiophysChem1997(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl, const realtype *spl, bool include_static);
extern void x0_Borghans_BiophysChem1997(realtype *x0, const realtype t, const realtype *p, const realtype *k);

extern void sx0_Borghans_BiophysChem1997(realtype *sx0, const realtype t, const realtype *x, const realtype *p, const realtype *k, const int ip);

extern void xdot_Borghans_BiophysChem1997(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void y_Borghans_BiophysChem1997(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
...
extern void x_solver_Borghans_BiophysChem1997(realtype *x_solver, const realtype *x_rdata);
...
extern std::vector<HermiteSpline> create_splines_Borghans_BiophysChem1997(const realtype *p, const realtype *k);
 ...
 */
class Model_Borghans_BiophysChem1997 : public amici::Model_ODE {
  public:
    /**
    ...
    Model_Borghans_BiophysChem1997()
        : amici::Model_ODE(
              ...
              amici::SimulationParameters(
                  ...
                  std::vector<realtype>{0.099948558015649294, 11.4120804594265, 0.19759394031018701, 0.39249751210747402, 1.1379496836123599, 0.99656746419647302, 0.200364133028272, 0.30335354705747197, 92.8739300577965, 7.4571244549222504, 22.702524882535101, 2.7568578434575901, 1.1239523025678699, 0.16323219530618899, 0.99999999999996003, 0.99934808443868695, 0.087920524425503799, 4.1025144127497004, 2.3177871577918698, 1.0048875569667699, 0.0, 0.0, 0.0}        // dynamic parameters
              ),
    ...
    amici::Model *clone() const override {
        return new Model_Borghans_BiophysChem1997(*this);
    }
    ...
    void fJy(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        Jy_Borghans_BiophysChem1997(Jy, iy, p, k, y, sigmay, my);
    }
    ...
    void fdJydsigma(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydsigma_Borghans_BiophysChem1997(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    void fdsigmaydp(realtype *dsigmaydp, const realtype t, const realtype *p, const realtype *k, const realtype *y, const int ip) override {
        dsigmaydp_Borghans_BiophysChem1997(dsigmaydp, t, p, k, y, ip);
    }
    ...
    void fdJydy(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydy_Borghans_BiophysChem1997(dJydy, iy, p, k, y, sigmay, my);
    }

    void fdJydy_colptrs(SUNMatrixWrapper &colptrs, int index) override {
        dJydy_colptrs_Borghans_BiophysChem1997(colptrs, index);
    }

    void fdJydy_rowvals(SUNMatrixWrapper &rowvals, int index) override {
        dJydy_rowvals_Borghans_BiophysChem1997(rowvals, index);
    }


    std::vector<HermiteSpline> fcreate_splines(const realtype *p, const realtype *k) override {
        return create_splines_Borghans_BiophysChem1997(p, k);
    }
    ...
    void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const realtype *spl, const realtype *sspl, bool include_static) override {
        dwdp_Borghans_BiophysChem1997(dwdp, t, x, p, k, h, w, tcl, dtcldp, spl, sspl, include_static);
    }

    void fdwdp_colptrs(SUNMatrixWrapper &colptrs) override {
        dwdp_colptrs_Borghans_BiophysChem1997(colptrs);
    }

    void fdwdp_rowvals(SUNMatrixWrapper &rowvals) override {
        dwdp_rowvals_Borghans_BiophysChem1997(rowvals);
    }
    ...
    void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *spl, bool include_static) override {
        dwdx_Borghans_BiophysChem1997(dwdx, t, x, p, k, h, w, tcl, spl, include_static);
    }

    void fdwdx_colptrs(SUNMatrixWrapper &colptrs) override {
        dwdx_colptrs_Borghans_BiophysChem1997(colptrs);
    }

    void fdwdx_rowvals(SUNMatrixWrapper &rowvals) override {
        dwdx_rowvals_Borghans_BiophysChem1997(rowvals);
    }
    ...
    void fdxdotdw(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdw_Borghans_BiophysChem1997(dxdotdw, t, x, p, k, h, w);
    }

    void fdxdotdw_colptrs(SUNMatrixWrapper &colptrs) override {
        dxdotdw_colptrs_Borghans_BiophysChem1997(colptrs);
    }

    void fdxdotdw_rowvals(SUNMatrixWrapper &rowvals) override {
        dxdotdw_rowvals_Borghans_BiophysChem1997(rowvals);
    }
    ...
    void fdydx(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx) override {
        dydx_Borghans_BiophysChem1997(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    void fdydp(realtype *dydp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const int ip, const realtype *w, const realtype *tcl, const realtype *dtcldp, const realtype *spl, const realtype *sspl) override {
        dydp_Borghans_BiophysChem1997(dydp, t, x, p, k, h, ip, w, tcl, dtcldp, spl, sspl);
    }
    ...
    void fsigmay(realtype *sigmay, const realtype t, const realtype *p, const realtype *k, const realtype *y) override {
        sigmay_Borghans_BiophysChem1997(sigmay, t, p, k, y);
    }
    ...
    void fsx0(realtype *sx0, const realtype t, const realtype *x, const realtype *p, const realtype *k, const int ip) override {
        sx0_Borghans_BiophysChem1997(sx0, t, x, p, k, ip);
    }
    ...
    void fw(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl, const realtype *spl, bool include_static) override {
        w_Borghans_BiophysChem1997(w, t, x, p, k, h, tcl, spl, include_static);
    }


    void fx0(realtype *x0, const realtype t, const realtype *p, const realtype *k) override {
        x0_Borghans_BiophysChem1997(x0, t, p, k);
    }
    ...
    void fxdot(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        xdot_Borghans_BiophysChem1997(xdot, t, x, p, k, h, w);
    }
    ...
    void fy(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        y_Borghans_BiophysChem1997(y, t, x, p, k, h, w);
    }
    ...
    void fx_solver(realtype *x_solver, const realtype *x_rdata) override {
        x_solver_Borghans_BiophysChem1997(x_solver, x_rdata);
    }
    ...
    std::string getName() const override {
        return "Borghans_BiophysChem1997";
    }
