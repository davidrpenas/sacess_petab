...
_Borghans_BiophysChem1997 = amici._module_from_path(
    'Borghans_BiophysChem1997._Borghans_BiophysChem1997' if __package__ or '.' in __name__
    else '_Borghans_BiophysChem1997',
    Path(__file__).parent / f'_Borghans_BiophysChem1997{ext_suffix}',
)

def _get_import_time():
    return _Borghans_BiophysChem1997._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Borghans_BiophysChem1997 from '
...
%module(package="Borghans_BiophysChem1997",moduleimport=MODULEIMPORT) Borghans_BiophysChem1997
