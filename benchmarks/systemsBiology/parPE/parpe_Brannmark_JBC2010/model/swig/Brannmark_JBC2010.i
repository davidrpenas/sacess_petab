...
_Brannmark_JBC2010 = amici._module_from_path(
    'Brannmark_JBC2010._Brannmark_JBC2010' if __package__ or '.' in __name__
    else '_Brannmark_JBC2010',
    Path(__file__).parent / f'_Brannmark_JBC2010{ext_suffix}',
)

def _get_import_time():
    return _Brannmark_JBC2010._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Brannmark_JBC2010 from '
...
%module(package="Brannmark_JBC2010",moduleimport=MODULEIMPORT) Brannmark_JBC2010
