...
_Bruno_JExpBot2016 = amici._module_from_path(
    'Bruno_JExpBot2016._Bruno_JExpBot2016' if __package__ or '.' in __name__
    else '_Bruno_JExpBot2016',
    Path(__file__).parent / f'_Bruno_JExpBot2016{ext_suffix}',
)

def _get_import_time():
    return _Bruno_JExpBot2016._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Bruno_JExpBot2016 from '
...
%module(package="Bruno_JExpBot2016",moduleimport=MODULEIMPORT) Bruno_JExpBot2016
