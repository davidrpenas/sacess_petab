...
_Chen_MSB2009 = amici._module_from_path(
    'Chen_MSB2009._Chen_MSB2009' if __package__ or '.' in __name__
    else '_Chen_MSB2009',
    Path(__file__).parent / f'_Chen_MSB2009{ext_suffix}',
)

def _get_import_time():
    return _Chen_MSB2009._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Chen_MSB2009 from '
...
%module(package="Chen_MSB2009",moduleimport=MODULEIMPORT) Chen_MSB2009
