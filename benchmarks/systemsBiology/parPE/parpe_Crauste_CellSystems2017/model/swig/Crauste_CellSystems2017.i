...
_Crauste_CellSystems2017 = amici._module_from_path(
    'Crauste_CellSystems2017._Crauste_CellSystems2017' if __package__ or '.' in __name__
    else '_Crauste_CellSystems2017',
    Path(__file__).parent / f'_Crauste_CellSystems2017{ext_suffix}',
)

def _get_import_time():
    return _Crauste_CellSystems2017._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Crauste_CellSystems2017 from '
...
%module(package="Crauste_CellSystems2017",moduleimport=MODULEIMPORT) Crauste_CellSystems2017
