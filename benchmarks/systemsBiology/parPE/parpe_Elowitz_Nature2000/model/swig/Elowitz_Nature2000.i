...
_Elowitz_Nature2000 = amici._module_from_path(
    'Elowitz_Nature2000._Elowitz_Nature2000' if __package__ or '.' in __name__
    else '_Elowitz_Nature2000',
    Path(__file__).parent / f'_Elowitz_Nature2000{ext_suffix}',
)

def _get_import_time():
    return _Elowitz_Nature2000._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Elowitz_Nature2000 from '
...
%module(package="Elowitz_Nature2000",moduleimport=MODULEIMPORT) Elowitz_Nature2000
