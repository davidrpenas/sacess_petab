...
_Fiedler_BMCSystBiol2016 = amici._module_from_path(
    'Fiedler_BMCSystBiol2016._Fiedler_BMCSystBiol2016' if __package__ or '.' in __name__
    else '_Fiedler_BMCSystBiol2016',
    Path(__file__).parent / f'_Fiedler_BMCSystBiol2016{ext_suffix}',
)

def _get_import_time():
    return _Fiedler_BMCSystBiol2016._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Fiedler_BMCSystBiol2016 from '
...
%module(package="Fiedler_BMCSystBiol2016",moduleimport=MODULEIMPORT) Fiedler_BMCSystBiol2016
