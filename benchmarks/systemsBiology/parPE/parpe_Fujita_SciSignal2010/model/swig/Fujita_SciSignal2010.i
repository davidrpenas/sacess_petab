...
_Fujita_SciSignal2010 = amici._module_from_path(
    'Fujita_SciSignal2010._Fujita_SciSignal2010' if __package__ or '.' in __name__
    else '_Fujita_SciSignal2010',
    Path(__file__).parent / f'_Fujita_SciSignal2010{ext_suffix}',
)

def _get_import_time():
    return _Fujita_SciSignal2010._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Fujita_SciSignal2010 from '
...
%module(package="Fujita_SciSignal2010",moduleimport=MODULEIMPORT) Fujita_SciSignal2010
