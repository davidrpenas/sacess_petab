...
_Giordano_Nature2020 = amici._module_from_path(
    'Giordano_Nature2020._Giordano_Nature2020' if __package__ or '.' in __name__
    else '_Giordano_Nature2020',
    Path(__file__).parent / f'_Giordano_Nature2020{ext_suffix}',
)

def _get_import_time():
    return _Giordano_Nature2020._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Giordano_Nature2020 from '
...
%module(package="Giordano_Nature2020",moduleimport=MODULEIMPORT) Giordano_Nature2020
