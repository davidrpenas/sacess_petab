...
_Isensee_JCB2018 = amici._module_from_path(
    'Isensee_JCB2018._Isensee_JCB2018' if __package__ or '.' in __name__
    else '_Isensee_JCB2018',
    Path(__file__).parent / f'_Isensee_JCB2018{ext_suffix}',
)

def _get_import_time():
    return _Isensee_JCB2018._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Isensee_JCB2018 from '
...
%module(package="Isensee_JCB2018",moduleimport=MODULEIMPORT) Isensee_JCB2018
