...
_Laske_PLOSComputBiol2019 = amici._module_from_path(
    'Laske_PLOSComputBiol2019._Laske_PLOSComputBiol2019' if __package__ or '.' in __name__
    else '_Laske_PLOSComputBiol2019',
    Path(__file__).parent / f'_Laske_PLOSComputBiol2019{ext_suffix}',
)

def _get_import_time():
    return _Laske_PLOSComputBiol2019._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Laske_PLOSComputBiol2019 from '
...
%module(package="Laske_PLOSComputBiol2019",moduleimport=MODULEIMPORT) Laske_PLOSComputBiol2019
