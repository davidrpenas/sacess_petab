...
_Lucarelli_CellSystems2018 = amici._module_from_path(
    'Lucarelli_CellSystems2018._Lucarelli_CellSystems2018' if __package__ or '.' in __name__
    else '_Lucarelli_CellSystems2018',
    Path(__file__).parent / f'_Lucarelli_CellSystems2018{ext_suffix}',
)

def _get_import_time():
    return _Lucarelli_CellSystems2018._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Lucarelli_CellSystems2018 from '
...
%module(package="Lucarelli_CellSystems2018",moduleimport=MODULEIMPORT) Lucarelli_CellSystems2018
