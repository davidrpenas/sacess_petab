...
extern void Jy_Okuonghae_ChaosSolitonsFractals2020(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydsigma_Okuonghae_ChaosSolitonsFractals2020(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_Okuonghae_ChaosSolitonsFractals2020(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_Okuonghae_ChaosSolitonsFractals2020(SUNMatrixWrapper &colptrs, int index);
extern void dJydy_rowvals_Okuonghae_ChaosSolitonsFractals2020(SUNMatrixWrapper &rowvals, int index);
...
extern void dwdp_Okuonghae_ChaosSolitonsFractals2020(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const realtype *spl, const realtype *sspl, bool include_static);
extern void dwdp_colptrs_Okuonghae_ChaosSolitonsFractals2020(SUNMatrixWrapper &colptrs);
extern void dwdp_rowvals_Okuonghae_ChaosSolitonsFractals2020(SUNMatrixWrapper &rowvals);
extern void dwdx_Okuonghae_ChaosSolitonsFractals2020(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *spl, bool include_static);
extern void dwdx_colptrs_Okuonghae_ChaosSolitonsFractals2020(SUNMatrixWrapper &colptrs);
extern void dwdx_rowvals_Okuonghae_ChaosSolitonsFractals2020(SUNMatrixWrapper &rowvals);
extern void dwdw_Okuonghae_ChaosSolitonsFractals2020(realtype *dwdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, bool include_static);
extern void dwdw_colptrs_Okuonghae_ChaosSolitonsFractals2020(SUNMatrixWrapper &colptrs);
extern void dwdw_rowvals_Okuonghae_ChaosSolitonsFractals2020(SUNMatrixWrapper &rowvals);
extern void dxdotdw_Okuonghae_ChaosSolitonsFractals2020(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_Okuonghae_ChaosSolitonsFractals2020(SUNMatrixWrapper &colptrs);
extern void dxdotdw_rowvals_Okuonghae_ChaosSolitonsFractals2020(SUNMatrixWrapper &rowvals);
...
extern void dydx_Okuonghae_ChaosSolitonsFractals2020(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);





extern void sigmay_Okuonghae_ChaosSolitonsFractals2020(realtype *sigmay, const realtype t, const realtype *p, const realtype *k, const realtype *y);

extern void dsigmaydp_Okuonghae_ChaosSolitonsFractals2020(realtype *dsigmaydp, const realtype t, const realtype *p, const realtype *k, const realtype *y, const int ip);


extern void w_Okuonghae_ChaosSolitonsFractals2020(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl, const realtype *spl, bool include_static);
extern void x0_Okuonghae_ChaosSolitonsFractals2020(realtype *x0, const realtype t, const realtype *p, const realtype *k);

extern void sx0_Okuonghae_ChaosSolitonsFractals2020(realtype *sx0, const realtype t, const realtype *x, const realtype *p, const realtype *k, const int ip);

extern void xdot_Okuonghae_ChaosSolitonsFractals2020(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void y_Okuonghae_ChaosSolitonsFractals2020(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
...
extern void x_solver_Okuonghae_ChaosSolitonsFractals2020(realtype *x_solver, const realtype *x_rdata);
...
extern std::vector<HermiteSpline> create_splines_Okuonghae_ChaosSolitonsFractals2020(const realtype *p, const realtype *k);
 ...
 */
class Model_Okuonghae_ChaosSolitonsFractals2020 : public amici::Model_ODE {
  public:
    /**
    ...
    Model_Okuonghae_ChaosSolitonsFractals2020()
        : amici::Model_ODE(
              ...
              amici::SimulationParameters(
                  std::vector<realtype>{0.80000000000000004, 0.0}, // fixedParameters
                  std::vector<realtype>{0.42359999999999998, 0.13977999999999999, 0.13977999999999999, 0.066666666666666666, 0.0135, 1.8999e-12, 0.014999999999999999, 0.014999999999999999, 0.19230769230769229, 0.5, 0.5, 441.0, 188.0, 212.0, 0.0, 0.0}        // dynamic parameters
              ),
    ...
    amici::Model *clone() const override {
        return new Model_Okuonghae_ChaosSolitonsFractals2020(*this);
    }
    ...
    void fJy(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        Jy_Okuonghae_ChaosSolitonsFractals2020(Jy, iy, p, k, y, sigmay, my);
    }
    ...
    void fdJydsigma(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydsigma_Okuonghae_ChaosSolitonsFractals2020(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    void fdsigmaydp(realtype *dsigmaydp, const realtype t, const realtype *p, const realtype *k, const realtype *y, const int ip) override {
        dsigmaydp_Okuonghae_ChaosSolitonsFractals2020(dsigmaydp, t, p, k, y, ip);
    }
    ...
    void fdJydy(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydy_Okuonghae_ChaosSolitonsFractals2020(dJydy, iy, p, k, y, sigmay, my);
    }

    void fdJydy_colptrs(SUNMatrixWrapper &colptrs, int index) override {
        dJydy_colptrs_Okuonghae_ChaosSolitonsFractals2020(colptrs, index);
    }

    void fdJydy_rowvals(SUNMatrixWrapper &rowvals, int index) override {
        dJydy_rowvals_Okuonghae_ChaosSolitonsFractals2020(rowvals, index);
    }


    std::vector<HermiteSpline> fcreate_splines(const realtype *p, const realtype *k) override {
        return create_splines_Okuonghae_ChaosSolitonsFractals2020(p, k);
    }
    ...
    void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const realtype *spl, const realtype *sspl, bool include_static) override {
        dwdp_Okuonghae_ChaosSolitonsFractals2020(dwdp, t, x, p, k, h, w, tcl, dtcldp, spl, sspl, include_static);
    }

    void fdwdp_colptrs(SUNMatrixWrapper &colptrs) override {
        dwdp_colptrs_Okuonghae_ChaosSolitonsFractals2020(colptrs);
    }

    void fdwdp_rowvals(SUNMatrixWrapper &rowvals) override {
        dwdp_rowvals_Okuonghae_ChaosSolitonsFractals2020(rowvals);
    }
    ...
    void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *spl, bool include_static) override {
        dwdx_Okuonghae_ChaosSolitonsFractals2020(dwdx, t, x, p, k, h, w, tcl, spl, include_static);
    }

    void fdwdx_colptrs(SUNMatrixWrapper &colptrs) override {
        dwdx_colptrs_Okuonghae_ChaosSolitonsFractals2020(colptrs);
    }

    void fdwdx_rowvals(SUNMatrixWrapper &rowvals) override {
        dwdx_rowvals_Okuonghae_ChaosSolitonsFractals2020(rowvals);
    }
    ...
    void fdwdw(realtype *dwdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, bool include_static) override {
        dwdw_Okuonghae_ChaosSolitonsFractals2020(dwdw, t, x, p, k, h, w, tcl, include_static);
    }

    void fdwdw_colptrs(SUNMatrixWrapper &colptrs) override {
        dwdw_colptrs_Okuonghae_ChaosSolitonsFractals2020(colptrs);
    }

    void fdwdw_rowvals(SUNMatrixWrapper &rowvals) override {
        dwdw_rowvals_Okuonghae_ChaosSolitonsFractals2020(rowvals);
    }
    ...
    void fdxdotdw(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdw_Okuonghae_ChaosSolitonsFractals2020(dxdotdw, t, x, p, k, h, w);
    }

    void fdxdotdw_colptrs(SUNMatrixWrapper &colptrs) override {
        dxdotdw_colptrs_Okuonghae_ChaosSolitonsFractals2020(colptrs);
    }

    void fdxdotdw_rowvals(SUNMatrixWrapper &rowvals) override {
        dxdotdw_rowvals_Okuonghae_ChaosSolitonsFractals2020(rowvals);
    }
    ...
    void fdydx(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx) override {
        dydx_Okuonghae_ChaosSolitonsFractals2020(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    void fsigmay(realtype *sigmay, const realtype t, const realtype *p, const realtype *k, const realtype *y) override {
        sigmay_Okuonghae_ChaosSolitonsFractals2020(sigmay, t, p, k, y);
    }
    ...
    void fsx0(realtype *sx0, const realtype t, const realtype *x, const realtype *p, const realtype *k, const int ip) override {
        sx0_Okuonghae_ChaosSolitonsFractals2020(sx0, t, x, p, k, ip);
    }
    ...
    void fw(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl, const realtype *spl, bool include_static) override {
        w_Okuonghae_ChaosSolitonsFractals2020(w, t, x, p, k, h, tcl, spl, include_static);
    }


    void fx0(realtype *x0, const realtype t, const realtype *p, const realtype *k) override {
        x0_Okuonghae_ChaosSolitonsFractals2020(x0, t, p, k);
    }
    ...
    void fxdot(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        xdot_Okuonghae_ChaosSolitonsFractals2020(xdot, t, x, p, k, h, w);
    }
    ...
    void fy(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        y_Okuonghae_ChaosSolitonsFractals2020(y, t, x, p, k, h, w);
    }
    ...
    void fx_solver(realtype *x_solver, const realtype *x_rdata) override {
        x_solver_Okuonghae_ChaosSolitonsFractals2020(x_solver, x_rdata);
    }
    ...
    std::string getName() const override {
        return "Okuonghae_ChaosSolitonsFractals2020";
    }
