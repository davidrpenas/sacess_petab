...
def get_extension() -> CMakeExtension:
    ...
    return CMakeExtension(
        ...
        install_prefix="Okuonghae_ChaosSolitonsFractals2020",
...
# Install
setup(
    name="Okuonghae_ChaosSolitonsFractals2020",
    cmdclass=CMDCLASS,
    version="0.1.0",
    description="AMICI-generated module for model Okuonghae_ChaosSolitonsFractals2020",
    url="https://github.com/AMICI-dev/AMICI",
    author="model-author-todo",
    author_email="model-author-todo",
    ext_modules=[MODEL_EXT],
    packages=find_namespace_packages(),
    install_requires=["amici==0.31.0"],
