...
_Okuonghae_ChaosSolitonsFractals2020 = amici._module_from_path(
    'Okuonghae_ChaosSolitonsFractals2020._Okuonghae_ChaosSolitonsFractals2020' if __package__ or '.' in __name__
    else '_Okuonghae_ChaosSolitonsFractals2020',
    Path(__file__).parent / f'_Okuonghae_ChaosSolitonsFractals2020{ext_suffix}',
)

def _get_import_time():
    return _Okuonghae_ChaosSolitonsFractals2020._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Okuonghae_ChaosSolitonsFractals2020 from '
...
%module(package="Okuonghae_ChaosSolitonsFractals2020",moduleimport=MODULEIMPORT) Okuonghae_ChaosSolitonsFractals2020
