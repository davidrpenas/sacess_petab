...
_Oliveira_NatCommun2021 = amici._module_from_path(
    'Oliveira_NatCommun2021._Oliveira_NatCommun2021' if __package__ or '.' in __name__
    else '_Oliveira_NatCommun2021',
    Path(__file__).parent / f'_Oliveira_NatCommun2021{ext_suffix}',
)

def _get_import_time():
    return _Oliveira_NatCommun2021._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Oliveira_NatCommun2021 from '
...
%module(package="Oliveira_NatCommun2021",moduleimport=MODULEIMPORT) Oliveira_NatCommun2021
