...
_Perelson_Science1996 = amici._module_from_path(
    'Perelson_Science1996._Perelson_Science1996' if __package__ or '.' in __name__
    else '_Perelson_Science1996',
    Path(__file__).parent / f'_Perelson_Science1996{ext_suffix}',
)

def _get_import_time():
    return _Perelson_Science1996._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Perelson_Science1996 from '
...
%module(package="Perelson_Science1996",moduleimport=MODULEIMPORT) Perelson_Science1996
