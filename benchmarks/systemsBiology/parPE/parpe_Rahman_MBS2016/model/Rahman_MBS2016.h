...
extern std::array<const char*, 21> expressionNames;
...
extern std::array<const char*, 21> expressionIds;
extern std::array<int, 7> stateIdxsSolver;
extern std::array<bool, 0> rootInitialValues;

extern void Jy_Rahman_MBS2016(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydsigma_Rahman_MBS2016(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_Rahman_MBS2016(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my);
extern void dJydy_colptrs_Rahman_MBS2016(SUNMatrixWrapper &colptrs, int index);
extern void dJydy_rowvals_Rahman_MBS2016(SUNMatrixWrapper &rowvals, int index);
...
extern void dwdp_Rahman_MBS2016(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const realtype *spl, const realtype *sspl, bool include_static);
extern void dwdp_colptrs_Rahman_MBS2016(SUNMatrixWrapper &colptrs);
extern void dwdp_rowvals_Rahman_MBS2016(SUNMatrixWrapper &rowvals);
extern void dwdx_Rahman_MBS2016(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *spl, bool include_static);
extern void dwdx_colptrs_Rahman_MBS2016(SUNMatrixWrapper &colptrs);
extern void dwdx_rowvals_Rahman_MBS2016(SUNMatrixWrapper &rowvals);
extern void dwdw_Rahman_MBS2016(realtype *dwdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, bool include_static);
extern void dwdw_colptrs_Rahman_MBS2016(SUNMatrixWrapper &colptrs);
extern void dwdw_rowvals_Rahman_MBS2016(SUNMatrixWrapper &rowvals);
extern void dxdotdw_Rahman_MBS2016(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void dxdotdw_colptrs_Rahman_MBS2016(SUNMatrixWrapper &colptrs);
extern void dxdotdw_rowvals_Rahman_MBS2016(SUNMatrixWrapper &rowvals);
...
extern void dydx_Rahman_MBS2016(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx);





extern void sigmay_Rahman_MBS2016(realtype *sigmay, const realtype t, const realtype *p, const realtype *k, const realtype *y);

extern void dsigmaydp_Rahman_MBS2016(realtype *dsigmaydp, const realtype t, const realtype *p, const realtype *k, const realtype *y, const int ip);


extern void w_Rahman_MBS2016(realtype *w, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *tcl, const realtype *spl, bool include_static);
extern void x0_Rahman_MBS2016(realtype *x0, const realtype t, const realtype *p, const realtype *k);



extern void xdot_Rahman_MBS2016(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
extern void y_Rahman_MBS2016(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w);
...
extern void x_solver_Rahman_MBS2016(realtype *x_solver, const realtype *x_rdata);
...
extern std::vector<HermiteSpline> create_splines_Rahman_MBS2016(const realtype *p, const realtype *k);
 ...
 */
class Model_Rahman_MBS2016 : public amici::Model_ODE {
  public:
    /**
    ...
    Model_Rahman_MBS2016()
        : amici::Model_ODE(
              ...
              amici::SimulationParameters(
                  std::vector<realtype>{1032672.0, 0.0, 0.0, 0.028799999999999999, 0.088800000000000004, 0.1368, 0.31080000000000002, 0.040800000000000003, 0.0528, 0.17519999999999999}, // fixedParameters
                  std::vector<realtype>{12.57, 0.082000000000000003, 4.54, 0.11, 0.33000000000000002, 0.34000000000000002, 0.56999999999999995, 0.81999999999999995, 2.4744e-7, 0.0}        // dynamic parameters
              ),
    ...
    amici::Model *clone() const override {
        return new Model_Rahman_MBS2016(*this);
    }
    ...
    void fJy(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        Jy_Rahman_MBS2016(Jy, iy, p, k, y, sigmay, my);
    }
    ...
    void fdJydsigma(realtype *dJydsigma, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my) override {
        dJydsigma_Rahman_MBS2016(dJydsigma, iy, p, k, y, sigmay, my);
    }
    ...
    void fdsigmaydp(realtype *dsigmaydp, const realtype t, const realtype *p, const realtype *k, const realtype *y, const int ip) override {
        dsigmaydp_Rahman_MBS2016(dsigmaydp, t, p, k, y, ip);
    }
    ...
    void fdwdp(realtype *dwdp, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *dtcldp, const realtype *spl, const realtype *sspl, bool include_static) override {
        dwdp_Rahman_MBS2016(dwdp, t, x, p, k, h, w, tcl, dtcldp, spl, sspl, include_static);
    }

    void fdwdp_colptrs(SUNMatrixWrapper &colptrs) override {
        dwdp_colptrs_Rahman_MBS2016(colptrs);
    }

    void fdwdp_rowvals(SUNMatrixWrapper &rowvals) override {
        dwdp_rowvals_Rahman_MBS2016(rowvals);
    }
    ...
    void fdwdx(realtype *dwdx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, const realtype *spl, bool include_static) override {
        dwdx_Rahman_MBS2016(dwdx, t, x, p, k, h, w, tcl, spl, include_static);
    }

    void fdwdx_colptrs(SUNMatrixWrapper &colptrs) override {
        dwdx_colptrs_Rahman_MBS2016(colptrs);
    }

    void fdwdx_rowvals(SUNMatrixWrapper &rowvals) override {
        dwdx_rowvals_Rahman_MBS2016(rowvals);
    }
    ...
    void fdwdw(realtype *dwdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl, bool include_static) override {
        dwdw_Rahman_MBS2016(dwdw, t, x, p, k, h, w, tcl, include_static);
    }

    void fdwdw_colptrs(SUNMatrixWrapper &colptrs) override {
        dwdw_colptrs_Rahman_MBS2016(colptrs);
    }

    void fdwdw_rowvals(SUNMatrixWrapper &rowvals) override {
        dwdw_rowvals_Rahman_MBS2016(rowvals);
    }
    ...
    void fdxdotdw(realtype *dxdotdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        dxdotdw_Rahman_MBS2016(dxdotdw, t, x, p, k, h, w);
    }

    void fdxdotdw_colptrs(SUNMatrixWrapper &colptrs) override {
        dxdotdw_colptrs_Rahman_MBS2016(colptrs);
    }

    void fdxdotdw_rowvals(SUNMatrixWrapper &rowvals) override {
        dxdotdw_rowvals_Rahman_MBS2016(rowvals);
    }
    ...
    void fdydx(realtype *dydx, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *dwdx) override {
        dydx_Rahman_MBS2016(dydx, t, x, p, k, h, w, dwdx);
    }
    ...
    void fsigmay(realtype *sigmay, const realtype t, const realtype *p, const realtype *k, const realtype *y) override {
        sigmay_Rahman_MBS2016(sigmay, t, p, k, y);
    }
    ...
    void fxdot(realtype *xdot, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        xdot_Rahman_MBS2016(xdot, t, x, p, k, h, w);
    }
    ...
    void fy(realtype *y, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w) override {
        y_Rahman_MBS2016(y, t, x, p, k, h, w);
    }
    ...
    void fx_solver(realtype *x_solver, const realtype *x_rdata) override {
        x_solver_Rahman_MBS2016(x_solver, x_rdata);
    }
