...
_Rahman_MBS2016 = amici._module_from_path(
    'Rahman_MBS2016._Rahman_MBS2016' if __package__ or '.' in __name__
    else '_Rahman_MBS2016',
    Path(__file__).parent / f'_Rahman_MBS2016{ext_suffix}',
)

def _get_import_time():
    return _Rahman_MBS2016._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Rahman_MBS2016 from '
...
%module(package="Rahman_MBS2016",moduleimport=MODULEIMPORT) Rahman_MBS2016
