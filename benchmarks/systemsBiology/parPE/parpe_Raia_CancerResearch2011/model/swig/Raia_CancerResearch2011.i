...
_Raia_CancerResearch2011 = amici._module_from_path(
    'Raia_CancerResearch2011._Raia_CancerResearch2011' if __package__ or '.' in __name__
    else '_Raia_CancerResearch2011',
    Path(__file__).parent / f'_Raia_CancerResearch2011{ext_suffix}',
)

def _get_import_time():
    return _Raia_CancerResearch2011._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Raia_CancerResearch2011 from '
...
%module(package="Raia_CancerResearch2011",moduleimport=MODULEIMPORT) Raia_CancerResearch2011
