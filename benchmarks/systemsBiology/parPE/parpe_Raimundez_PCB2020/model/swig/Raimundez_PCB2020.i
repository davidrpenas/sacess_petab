...
_Raimundez_PCB2020 = amici._module_from_path(
    'Raimundez_PCB2020._Raimundez_PCB2020' if __package__ or '.' in __name__
    else '_Raimundez_PCB2020',
    Path(__file__).parent / f'_Raimundez_PCB2020{ext_suffix}',
)

def _get_import_time():
    return _Raimundez_PCB2020._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Raimundez_PCB2020 from '
...
%module(package="Raimundez_PCB2020",moduleimport=MODULEIMPORT) Raimundez_PCB2020
