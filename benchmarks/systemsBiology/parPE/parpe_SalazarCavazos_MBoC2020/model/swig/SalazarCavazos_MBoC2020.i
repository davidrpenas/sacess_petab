...
_SalazarCavazos_MBoC2020 = amici._module_from_path(
    'SalazarCavazos_MBoC2020._SalazarCavazos_MBoC2020' if __package__ or '.' in __name__
    else '_SalazarCavazos_MBoC2020',
    Path(__file__).parent / f'_SalazarCavazos_MBoC2020{ext_suffix}',
)

def _get_import_time():
    return _SalazarCavazos_MBoC2020._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for SalazarCavazos_MBoC2020 from '
...
%module(package="SalazarCavazos_MBoC2020",moduleimport=MODULEIMPORT) SalazarCavazos_MBoC2020
