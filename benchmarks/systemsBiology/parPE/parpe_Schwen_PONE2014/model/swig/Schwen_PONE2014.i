...
_Schwen_PONE2014 = amici._module_from_path(
    'Schwen_PONE2014._Schwen_PONE2014' if __package__ or '.' in __name__
    else '_Schwen_PONE2014',
    Path(__file__).parent / f'_Schwen_PONE2014{ext_suffix}',
)

def _get_import_time():
    return _Schwen_PONE2014._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Schwen_PONE2014 from '
...
%module(package="Schwen_PONE2014",moduleimport=MODULEIMPORT) Schwen_PONE2014
