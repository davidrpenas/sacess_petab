...
_Smith_BMCSystBiol2013 = amici._module_from_path(
    'Smith_BMCSystBiol2013._Smith_BMCSystBiol2013' if __package__ or '.' in __name__
    else '_Smith_BMCSystBiol2013',
    Path(__file__).parent / f'_Smith_BMCSystBiol2013{ext_suffix}',
)

def _get_import_time():
    return _Smith_BMCSystBiol2013._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Smith_BMCSystBiol2013 from '
...
%module(package="Smith_BMCSystBiol2013",moduleimport=MODULEIMPORT) Smith_BMCSystBiol2013
