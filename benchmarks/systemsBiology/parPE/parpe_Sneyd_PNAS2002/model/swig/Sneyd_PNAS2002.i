...
_Sneyd_PNAS2002 = amici._module_from_path(
    'Sneyd_PNAS2002._Sneyd_PNAS2002' if __package__ or '.' in __name__
    else '_Sneyd_PNAS2002',
    Path(__file__).parent / f'_Sneyd_PNAS2002{ext_suffix}',
)

def _get_import_time():
    return _Sneyd_PNAS2002._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Sneyd_PNAS2002 from '
...
%module(package="Sneyd_PNAS2002",moduleimport=MODULEIMPORT) Sneyd_PNAS2002
