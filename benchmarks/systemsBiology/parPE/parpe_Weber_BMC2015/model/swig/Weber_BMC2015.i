...
_Weber_BMC2015 = amici._module_from_path(
    'Weber_BMC2015._Weber_BMC2015' if __package__ or '.' in __name__
    else '_Weber_BMC2015',
    Path(__file__).parent / f'_Weber_BMC2015{ext_suffix}',
)

def _get_import_time():
    return _Weber_BMC2015._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Weber_BMC2015 from '
...
%module(package="Weber_BMC2015",moduleimport=MODULEIMPORT) Weber_BMC2015
