...
_Zhao_QuantBiol2020 = amici._module_from_path(
    'Zhao_QuantBiol2020._Zhao_QuantBiol2020' if __package__ or '.' in __name__
    else '_Zhao_QuantBiol2020',
    Path(__file__).parent / f'_Zhao_QuantBiol2020{ext_suffix}',
)

def _get_import_time():
    return _Zhao_QuantBiol2020._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Zhao_QuantBiol2020 from '
...
%module(package="Zhao_QuantBiol2020",moduleimport=MODULEIMPORT) Zhao_QuantBiol2020
