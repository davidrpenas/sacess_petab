...
_Zheng_PNAS2012 = amici._module_from_path(
    'Zheng_PNAS2012._Zheng_PNAS2012' if __package__ or '.' in __name__
    else '_Zheng_PNAS2012',
    Path(__file__).parent / f'_Zheng_PNAS2012{ext_suffix}',
)

def _get_import_time():
    return _Zheng_PNAS2012._get_import_time()
...
if t_imported < t_modified:
    ...
    raise RuntimeError(
        f'Cannot import extension for Zheng_PNAS2012 from '
...
%module(package="Zheng_PNAS2012",moduleimport=MODULEIMPORT) Zheng_PNAS2012
